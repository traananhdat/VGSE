...
CUDA_VISIBLE_DEVICES=${device} python VGSE/SJE/SJE.py --image_embedding res101 --class_embedding VGSE_SMO \
...
echo run w2v ZSL
CUDA_VISIBLE_DEVICES=${device} python VGSE/SJE/SJE.py --image_embedding res101 --class_embedding  word2vec \
--nepoch 200 --classifier_lr 0.00001 --dataset ${DATASET}  --batch_size 64 --manualSeed 5214
